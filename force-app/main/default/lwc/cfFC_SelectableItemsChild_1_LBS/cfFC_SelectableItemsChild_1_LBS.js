import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfFC_SelectableItemsChild_1_LBS extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfFC_SelectableItemsChild_1_LBS';
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`selectcards_selectedItems`,this._allMergeFields,this._regexPattern,"noparse");
