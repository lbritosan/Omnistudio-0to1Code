...
import { OMNIDEF } from './apexHoursSampleOmniEnglish_def.js';
import tmpl from './apexHoursSampleOmniEnglish.html';
import tmpl_nds from './apexHoursSampleOmniEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class apexHoursSampleOmniEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
