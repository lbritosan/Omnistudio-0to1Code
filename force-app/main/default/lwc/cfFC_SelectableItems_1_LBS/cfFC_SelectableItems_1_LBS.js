import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfFC_SelectableItems_1_LBS extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              ...
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfFC_SelectableItems_1_LBS';
